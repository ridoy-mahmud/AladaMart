...
export default function Register() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col-reverse md:flex-row rounded-3xl overflow-hidden shadow-2xl max-w-6xl mx-auto my-8 bg-white border border-slate-100">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          <h2 className="text-[32px] font-bold text-[#111111] mb-2 leading-tight">
            Create an account <span className="inline-block origin-bottom-right hover:rotate-12 transition-transform cursor-default">👋</span>
          </h2>
          <p className="text-slate-500 mb-8">Join AladaMart to unlock exclusive benefits.</p>
          ...
          <div className="grid grid-cols-1 gap-4 mb-6">
            ...
            >
              ...
              <span className="font-semibold text-slate-700 text-[15px]">Sign up with Google</span>
            </button>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full py-3.5 bg-primary hover:bg-primary/90 text-white rounded-xl font-semibold text-[16px] transition-colors mt-6 shadow-sm"
            >
      ...
      <div className="hidden md:flex w-1/2 relative items-center justify-center bg-slate-900 overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1555529733-0e670560f4e1?q=80&w=1974&auto=format&fit=crop" 
          alt="Register" 
          className="absolute inset-0 w-full h-full object-cover opacity-40" 
        />
        <div className="relative z-10 p-12 text-white text-center">
          <h2 className="text-4xl font-bold mb-4">Unlimited Benefits</h2>
          <p className="text-lg text-slate-300 max-w-xs mx-auto">Get exclusive shopping offers, discounts, and personalized recommendations.</p>
        </div>
      </div>
    </div>
  );
